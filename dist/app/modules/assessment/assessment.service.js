...
const createAssessmentSession = async (userId, payload) => {
    const session = await AssessmentSession.findOne({ userId });
    const sessionId = session?._id;
    const result = await AssessmentSession.findByIdAndUpdate(sessionId, { $push: { answers: { $each: payload } } }, { new: true });
    return result;
};
const getAssessmentSessionById = async (id) => {
...
const getAssessmentSessionsByUser = async (userId) => {
...
const getAssessmentByUser = async (userId) => {
...
const updateAssessmentSession = async (id) => {
